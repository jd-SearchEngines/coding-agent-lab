...
|---|---|---|---|---|---|---|---|---|---|
| 1. 100行代码真的能做Coding Agent吗？ | v0.1-minimal | `0545336f` | case_001–005 | self-report is not proof | Minimal Agent Loop | 0/5 pass; 5 false finishes | all cases false-finish | a loop can act busy without solving | `docs/content/EP01/` |
